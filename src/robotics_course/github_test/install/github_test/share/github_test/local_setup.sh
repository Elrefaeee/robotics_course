...
: ${AMENT_CURRENT_PREFIX:="/home/elrefaee/ros2_ws/src/github_test/install/github_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/github_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/github_test/environment/path.sh"
